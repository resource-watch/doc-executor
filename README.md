...
[![Build Status](https://travis-ci.com/resource-watch/doc-executor.svg?branch=dev)](https://travis-ci.com/resource-watch/doc-executor)
...
The Document Executor microservice is built using [Node.js](https://nodejs.org/en/), and can be executed either natively or using Docker, each of which has its own set of requirements.
