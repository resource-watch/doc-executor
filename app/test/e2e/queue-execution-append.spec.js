...
describe('EXECUTION_APPEND handling process', () => {
    ...
    it('Consume a EXECUTION_APPEND message with custom mappings and create a new task and STATUS_INDEX_DEACTIVATED, STATUS_READ_DATA for per file and STATUS_READ_FILE messages (happy case for mupltiple files)', async () => {
        const timestamp = new Date().getTime();
